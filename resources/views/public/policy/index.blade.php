...
@section('content')
    <div class="page">
        <div class="header">
            <div class="container">
                <p class="title">Privacy Policy for Babi 2 School</p>
            </div>
        </div>
            ...
            <div class="container">
                <div class="tab-content translations-content-item en visible" id="en">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Application</strong> refers to Babi 2 School, the software program provided by the
                                Company.</p>
                        </li>
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                                Agreement) refers to HP Tech JSC, 12th floor, Viettel Tower A2, 285 Cách Mạng Tháng Tám,
                                Ward 12, District 10, Hồ Chí Minh city.</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: cskh@babi2school.com.vn</li>
                    </ul>
                </div>
            </div>
        </div>
