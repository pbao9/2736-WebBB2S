                ...
                <div class="blog">
                    ...
                    <ul>
                        ...
                        <div class="row row-0 gap-3 mb-3">
                            <div class="col-3">
                                <a href="{{ route('blog.show', $post->slug) }}"><img src="{{ asset($post->image) }}" class="w-100 h-100 object-cover card-img-start" alt="Bài Post"></a>
                            </div>
                            <div class="col">
                                <div class="card-body">
            ...
            <aside class="col-md-3">
                <div class="py-4">
                    ...
                    <ul class="text-primary categories-blog list-unstyled">
                        ...
                        <li class="py-3 border-bottom"><a href="{{ route('blog.show_category', $cat->slug) }}" class="text-decoration-none">{{ $cat->name}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </aside>
