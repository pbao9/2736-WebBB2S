    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-md-9 col-12 pe-lg-4 pe-0">
                <h1 class="text-center text-uppercase fw-bold" style="font-size: 150%">dịch vụ đưa đón 01 chiều</h1>
                    ...
                    <div class="banner-bg fill">
                        ...
                        <div class="banner-content position-absolute top-50 start-50 translate-middle text-center w-100">
                            <div class="content-banner mx-5 px-5  animate__animated animate__flipInY animate__slow">
                                <div class="is-diviner mx-auto"></div>
                                <h1 class="text-white mb-3 text-uppercase" style="font-size: 150%"><b>DỊCH VỤ ĐÓN BÉ LÚC
                                        4:00 chiều</b></h1>
                                <p><span style="font-size: 150%;" class="text-white">Giá chỉ từ: 59.000 VNĐ / học sinh/ 01
                                        ngày/ 01 chiều bán kính 5km từ trường về nhà</span></p>
                                <div class="is-diviner mx-auto"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-box py-3">
                    <div>
                        ...
                        <ol style="line-height: 35px">
                            ...
                            <li>Giá: <strong>1.300.000 VNĐ/ Học sinh/01 chiều đón/ bán kính trong vòng 5 km từ nhà học sinh
